...
def main():
    print('Mohd Owais Ghazi')
    print('E22MCAG0035')
    print('welcome to XYZ pizza creation software..........')

    Greek = int(input("Enter The prize of Greek pizza "))
    Chicago = int(input("Enter The prize of Chicago pizza "))

    NewYork = int(input("Enter The prize of NewYork pizza "))
    Sicilian = int(input("Enter The prize of Sicilian pizza "))

    PlumTomato = int(input("Enter The prize of PlumTomato Sauce "))
    Marinara = int(input("Enter The prize of Marinara Sauce "))

    Barbecue = int(input("Enter The prize of Barbecue Sauce "))
    Pumpkin = int(input("Enter The prize of Pumpkin Sauce "))

    ThinCrust = int(input("Enter The prize of ThinCrust "))
    ThickCrust = int(input("Enter The prize of ThickCrust "))

    Mozzarella = int(input("Enter The prize of Mozzarella Cheese "))
    Reggiano = int(input("Enter The prize of Reggiano Cheese "))

    Provolone = int(input("Enter The prize of Provolone Cheese "))
    Parmesan = int(input("Enter The prize of Parmesan Cheese "))
